...
const WHATSAPP_TEXT = encodeURIComponent(
  "Interested in your automation services. [please type your question or enquiry]"
);

const contacts = [
  {
    label: "Telegram",
    href: "https://t.me/ethnoh",
    icon: (
  ...
  {
    label: "WhatsApp",
    href: `https://api.whatsapp.com/send?text=${WHATSAPP_TEXT}`,
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden>
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/edgars-jubelis-35ab9b339",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden>
    ...
    >
      {contacts.map((c, i) => (
        <motion.a
          ...
          style={{
            background: "#A0522D",
            boxShadow: "0 4px 14px rgba(160,82,45,0.45)",
          }}
